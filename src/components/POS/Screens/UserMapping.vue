...
<div>
        ...
        <UserMappingPanel v-if="currentItem" :model="scheme" :data="currentItem" />
</div>
</template>

<script>
import allMappingModel from '../model/Customer/AllMappingModel'
import UserMappingPanel from "../Components/Panel/UserMappingPanel";
export default {
  components: {
    UserMappingPanel: UserMappingPanel,
  },
  async mounted() {

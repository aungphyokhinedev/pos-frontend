  ...
  <v-content>
    <v-container fluid>
      ...
      <v-card v-if="isadding">
        ...
        <v-card-text>
          ...
          <v-row  align="center" justify="center">
            <v-btn color="primary" dark @click="search">Search Items</v-btn>
          </v-row>
        </v-card-text>
      </v-card>
      ...
      <v-btn
        ...
        fab
      >
        <v-icon dark>{{isadding?'list':'search'}}</v-icon>
      </v-btn>
    </v-container>
  </v-content>
</template>
...
export default {
  ...
  methods: {
    ...
    async search() {
        ...
        // Dispatch the action to buy a TV
      await this.$store.dispatch("commongeolocation/searchItems", {

...
const actions = {
  ...
  getItem ({ commit }, id) {
    ...
    return axios
    .post(constants.baseUrl + 'pos/discount/' + id)
      .then(response => {
  ...
  getItems ({ commit, state }, qurey) {
    ...
    if(!state.loading) {
      commit('setLoading', true)
      axios
        .post(constants.baseUrl + 'pos/discount/list',qurey)
        .then(response => {
  ...
  createItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .post(constants.baseUrl + 'pos/discount',payload)
      .then(() => {
  ...
  updateItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .put(constants.baseUrl + 'pos/discount/' + payload._id,payload)
      .then(() => {
  ...
  deleteItem ({ commit }, id) {
    ...
    return axios
      .delete(constants.baseUrl + 'pos/discount/' + id)
      .then(() => {

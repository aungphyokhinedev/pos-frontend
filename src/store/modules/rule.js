...
const actions = {
  ...
  getItem ({ commit }, id) {
    ...
    return axios
    .post(constants.baseUrl + 'rule/' + id)
      .then(response => {
  ...
  getItems ({ commit, state }, qurey) {
    ...
    if(!state.loading) {
      commit('setLoading', true)
      axios
        .post(constants.baseUrl + 'rule/list',qurey)
        .then(response => {
  ...
  createItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .post(constants.baseUrl + 'rule',payload)
      .then(() => {
  ...
  updateItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .put(constants.baseUrl + 'rule/' + payload._id,payload)
      .then(() => {
  ...
  deleteItem ({ commit }, id) {
    ...
    return axios
      .delete(constants.baseUrl + 'rule/' + id)
      .then(() => {

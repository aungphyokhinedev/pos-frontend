...
const actions = {
  ...
  getItem ({ commit }, id) {
    ...
    return axios
    .post(constants.baseUrl + 'pos/item/' + id)
      .then(response => {
  ...
  getItems ({ commit, state }, qurey) {
    ...
    if(!state.loading) {
      commit('setLoading', true)
      axios
        .post(constants.baseUrl + 'pos/item/list',qurey)
        .then(response => {
  ...
  createItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .post(constants.baseUrl + 'pos/item',payload)
      .then(() => {
  ...
  updateItem ({ commit }, payload) {
    ...
    console.log(payload)
    return axios
      .put(constants.baseUrl + 'pos/item/' + payload._id,payload)
      .then(() => {
  ...
  deleteItem ({ commit }, id) {
    ...
    return axios
      .delete(constants.baseUrl + 'pos/item/' + id)
      .then(() => {
